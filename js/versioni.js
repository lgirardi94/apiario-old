// ===== FILE VERSION: 2026-05-28.26 · versioni.js =====
/* ===========================================================
...
const FILE_VERSIONS = {
  // HTML
  'index.html':                { path: 'index.html',            ver: '2026-05-28.32' },
  'visita_rapida.html':        { path: 'visita_rapida.html',    ver: '2026-05-28.8' },
  'inserimento_rapido.html':   { path: 'inserimento_rapido.html', ver: '2026-05-28.10' },
  'todo.html':                 { path: 'todo.html',             ver: '2026-05-28.3' },
  'etichette.html':            { path: 'etichette.html',        ver: '2026-05-28.3' },
  // Core
  ...
  'js/insights.js':            { path: 'js/insights.js',        ver: '2026-05-28.8' },
  ...
  'js/versioni.js':            { path: 'js/versioni.js',        ver: '2026-05-28.26' },
};

// Versione "build" complessiva dell'app (la più recente tra tutte)
const APP_BUILD = '2026-05-28.32';
